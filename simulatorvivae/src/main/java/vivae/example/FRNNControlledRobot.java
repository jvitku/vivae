...
public class FRNNControlledRobot extends Robot {
    ...
    ///my
    public void setDistanceSensors(int howMany, double startingAngle, double angleIncrement,
    		double frictionDistance){
    	for (int i = 0; i < howMany; i++) {
            addFrictionSensor(startingAngle + i * angleIncrement, frictionDistance);
        }
    }
    ///my
    public void setFrictionSensors(int howMany, double startingAngle, double angleIncrement,
    		double maxDistance){
    	for (int i = 0; i < howMany; i++) {
