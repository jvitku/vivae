package vivae.ros.simulatorControlsServer.tests;
 ...
 * 
 * Note: this sends requests to vivae simulator: ControlsServer, so this must be running in the ROS network (e.g. in Nengo)
 * 
