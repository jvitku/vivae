package vivae.ros.simulator.engine.agents.impl;
...
public class SynchronousROSAgent extends RobotWithSensorController implements RosAgent{
		...
		/* (non-Javadoc)
		 * @see vivae.ros.simulator.engine.agents.RosAgentt#moveControlledObject()
		 */
		@Override
		...
		// setters and getters..
		/* (non-Javadoc)
		 * @see vivae.ros.simulator.engine.agents.RosAgentt#getMaxSensorDistance()
		 */
		@Override
		...
		/* (non-Javadoc)
		 * @see vivae.ros.simulator.engine.agents.RosAgentt#setMaxSensorDistance(double)
		 */
		@Override
		...
		/* (non-Javadoc)
		 * @see vivae.ros.simulator.engine.agents.RosAgentt#getFrictionDistance()
		 */
		@Override
		...
		/* (non-Javadoc)
		 * @see vivae.ros.simulator.engine.agents.RosAgentt#setFrictionDistance(double)
		 */
		@Override
		...
		/* (non-Javadoc)
		 * @see vivae.ros.simulator.engine.agents.RosAgentt#getNumSensors()
		 */
		@Override
		...
		/* (non-Javadoc)
		 * @see vivae.ros.simulator.engine.agents.RosAgentt#setNumSensors(int)
		 */
		@Override
		...
		/* (non-Javadoc)
		 * @see vivae.ros.simulator.engine.agents.RosAgentt#getPubTopic()
		 */
		@Override
		...
		/* (non-Javadoc)
		 * @see vivae.ros.simulator.engine.agents.RosAgentt#getSubTopic()
		 */
		@Override
		...
		/* (non-Javadoc)
		 * @see vivae.ros.simulator.engine.agents.RosAgentt#getName()
		 */
		@Override
		public String getName(){ return name; }

		/* (non-Javadoc)
		 * @see vivae.ros.simulator.engine.agents.RosAgentt#setSensoryDataLength(int)
		 */
		@Override
		...
		/* (non-Javadoc)
		 * @see vivae.ros.simulator.engine.agents.RosAgentt#getSensoryDataLength()
		 */
		@Override
